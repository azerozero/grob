...
impl DlpEngine {
    /// Returns whether request (input) scanning is enabled.
    #[must_use]
    pub fn scan_input_enabled(&self) -> bool {
        self.config.scan_input
    }

    /// Returns whether response (output) scanning is enabled.
    #[must_use]
    pub fn scan_output_enabled(&self) -> bool {
