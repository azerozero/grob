...
const ADJECTIVES: &[&str] = &[
    ...
    "Yankee", "Zulu", "Iron", "Copper", "Silver", "Golden", "Cobalt", "Onyx",
    "Arctic", "Boreal", "Crimson", "Dusk", "Ember", "Frost", "Granite", "Hollow",
    "Ivory", "Jasper", "Kelvin", "Lunar", "Mist", "Noble", "Orbit", "Prism",
    "Radiant", "Stellar", "Tempest", "Ultra", "Vivid", "Winter", "Zenith", "Azure",
    "Beryl", "Citrine", "Dune", "Flint", "Glacier", "Helix", "Indigo", "Jet",
];

const NOUNS: &[&str] = &[
    "Phoenix", "Falcon", "Eagle", "Condor", "Hawk", "Raven", "Sparrow", "Crane",
    "Osprey", "Heron", "Pelican", "Albatross", "Starling", "Finch", "Robin", "Wren",
    "Cedar", "Maple", "Birch", "Willow", "Pine", "Oak", "Elm", "Ash",
    "Coral", "Amber", "Jade", "Pearl", "Opal", "Quartz", "Topaz", "Garnet",
    "Lynx", "Otter", "Puma", "Fox", "Wolf", "Bear", "Seal", "Elk",
    "Agate", "Basalt", "Cinder", "Drift", "Ember", "Forge", "Gale", "Helm",
    "Isle", "Jetty", "Knoll", "Ledge", "Mesa", "North", "Pass", "Ridge",
    "Shoal", "Tor", "Vale", "Arch", "Brook", "Cape", "Dell", "Fjord",
];
