...
**OAuth Configuration:**
```
client_id: <GEMINI_OAUTH_CLIENT_ID or default from google-gemini/gemini-cli>
client_secret: <GEMINI_OAUTH_CLIENT_SECRET or default from google-gemini/gemini-cli>
