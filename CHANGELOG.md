...
- *(credentials)* harden injection and storage key custody ([#611](https://github.com/azerozero/grob/pull/611))
...
- *(security)* harden credential and streaming lifecycles ([#604](https://github.com/azerozero/grob/pull/604))
...
## [0.36.63](https://github.com/azerozero/grob/compare/v0.36.62...v0.36.63) - 2026-06-02
...
## [0.36.57](https://github.com/azerozero/grob/compare/v0.36.56...v0.36.57) - 2026-05-31
...
- *(rpc)* impl tools/enable + tools/disable with in-memory mutation ([#228](https://github.com/azerozero/grob/pull/228))
