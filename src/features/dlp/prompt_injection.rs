...
impl InjectionDetector {
    pub fn new(config: PromptInjectionConfig, hot_config: SharedHotConfig) -> Self {
        ...
        if !config.no_builtins {
            ...
            if lang_enabled(langs, "en") {
                patterns.extend(builtin_en_patterns());
            }
            if lang_enabled(langs, "fr") {
                patterns.extend(builtin_fr_patterns());
            }
            if lang_enabled(langs, "de") {
                patterns.extend(builtin_de_patterns());
            }
            if lang_enabled(langs, "es") {
                patterns.extend(builtin_es_patterns());
            }
            if lang_enabled(langs, "it") {
                patterns.extend(builtin_it_patterns());
            }
            if lang_enabled(langs, "pt") {
                patterns.extend(builtin_pt_patterns());
            }
            if lang_enabled(langs, "nl") {
                patterns.extend(builtin_nl_patterns());
            }
            if lang_enabled(langs, "pl") {
                patterns.extend(builtin_pl_patterns());
            }
            if lang_enabled(langs, "ro") {
                patterns.extend(builtin_ro_patterns());
            }
            if lang_enabled(langs, "hu") {
                patterns.extend(builtin_hu_patterns());
            }
            if lang_enabled(langs, "cs") {
                patterns.extend(builtin_cs_patterns());
            }
            if lang_enabled(langs, "el") {
                patterns.extend(builtin_el_patterns());
            }
            if lang_enabled(langs, "bg") {
                patterns.extend(builtin_bg_patterns());
            }
            if lang_enabled(langs, "sv") {
                patterns.extend(builtin_sv_patterns());
            }
            if lang_enabled(langs, "da") {
                patterns.extend(builtin_da_patterns());
            }
            if lang_enabled(langs, "fi") {
                patterns.extend(builtin_fi_patterns());
            }
            if lang_enabled(langs, "ru") {
                patterns.extend(builtin_ru_patterns());
            }
            if lang_enabled(langs, "uk") {
                patterns.extend(builtin_uk_patterns());
            }
            if lang_enabled(langs, "tr") {
                patterns.extend(builtin_tr_patterns());
            }
            if lang_enabled(langs, "ar") {
                patterns.extend(builtin_ar_patterns());
            }
            if lang_enabled(langs, "zh") {
                patterns.extend(builtin_zh_patterns());
            }
            if lang_enabled(langs, "ja") {
                patterns.extend(builtin_ja_patterns());
            }
            if lang_enabled(langs, "ko") {
                patterns.extend(builtin_ko_patterns());
            }
            if lang_enabled(langs, "hi") {
                patterns.extend(builtin_hi_patterns());
            }
            if lang_enabled(langs, "th") {
                patterns.extend(builtin_th_patterns());
            }
            if lang_enabled(langs, "vi") {
                patterns.extend(builtin_vi_patterns());
            }
            if lang_enabled(langs, "id") {
                patterns.extend(builtin_id_patterns());
            }
            if lang_enabled(langs, "eo") {
                patterns.extend(builtin_eo_patterns());
            }
